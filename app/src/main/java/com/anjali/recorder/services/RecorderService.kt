...
import com.anjali.recorder.receivers.FinishedNotificationReceiver
import com.anjali.recorder.ui.MainActivity
...
abstract class RecorderService : LifecycleService() {
    ...
    companion object {
        const val RECORDER_INTENT_ACTION = "com.anjali.recorder.RECORDER_ACTION"
